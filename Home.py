...
st.write('"_La solución que proponemos es un dashboard interactivo e intuitivo de fácil uso para el público en general, con datos precisos que generen consciencia en la sociedad peruana._"')

st.subheader("Datos de los últimos 10 accidentes de tránsito hasta la fecha")
st.divider()
